                ...
                <div className="main__container">
                    <div className="main__header">
                        ...
                        <div className="main__header--picture">
                            <img className="main__header--picture-img" src="https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_92x30dp.png" alt="picture" />
                        </div>
                    </div>
                    ...
                    <div className="main__contents">
                        <div className="main__contents--recomm">
                            ...
                            <div className="main__contents--recomm-routine">
                                <img className="main__contents--recomm-routine-img" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFeqFhshZ-zRrt6bIrYehbUGKEQBexCAWeDg&usqp=CAU" alt="picture" />
